...
namespace AdventureBot.TriggerFunctions
{
    public partial class HttpTriggerUserProfile
    {
        ...
        {
            private const string prefix = nameof(UserProfile);
        ...
        private static class Route
        {
            ...
            public const string List = prefix + "/list/{" + Parameter.partitionKey + ":required}";
            public const string Search = prefix + "/search/{" + Parameter.partitionKey + ":required}/{"+ Parameter.PreferredUsername + ":required}";
